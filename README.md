...
```mermaid
    classDiagram
    OrderItems <.. Tables
    OrderItems <.. LoyaltyCards
    OrderItems <.. MenuItems
    OrderItems <.. Employees
    OrderItems <.. Employees
    Employees .. EmployeeTypes
    LoyaltyCards .. LoyaltyCardsTypes
    Employees <..> Persons
    BaseAuditEntity ||--o{ OrderItems
    BaseAuditEntity ||--o{ MenuItems
    BaseAuditEntity ||--o{ LoyaltyCards
    BaseAuditEntity ||--o{ Tables
    BaseAuditEntity ||--o{ Employees
    BaseAuditEntity ||--o{ Persons
    class Tables {
        Guid Id
        string Number
    }
